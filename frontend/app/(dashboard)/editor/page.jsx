...
import { Archive, CheckCircle2, Clapperboard, LayoutDashboard, Send } from "lucide-react";
...
const navItems = [
  ...
  { href: "/editor/edit-queue", label: "Edit Queue", icon: Clapperboard },
  { href: "/editor/submitted", label: "Submitted", icon: Send },
  { href: "/editor/archive", label: "Archive", icon: Archive },
];
        ...
        <Card className="border-[#10B981]/30 bg-gradient-to-r from-[#10B981]/15 to-transparent">
          <CardContent className="flex items-center justify-between p-6">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">Start editing and submit your final edit.</p>
            </div>
                          ...
                          {status === "in_progress" ? (
                            <>
                              <div className="space-y-1">
                                <p className="text-xs text-muted-foreground">Edited File Link</p>
                                <Input
                                  type="url"
